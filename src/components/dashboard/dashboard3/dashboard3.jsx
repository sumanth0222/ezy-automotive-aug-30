...
import { COLUMNS3, DATATABLE3, GlobalFilter } from "../../../common/tablesfunctionaldata";
      ...
      <Row>
        <Col xl={6} lg={12} md={12} sm={12}>
          <Card className=" custom-card overflow-hidden">
            ...
            <Card.Body>
              <div id="statistics3"><Statistics3/></div>
            </Card.Body>
          </Card>
        </Col>
