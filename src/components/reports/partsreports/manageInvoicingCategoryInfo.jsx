...
const ManageInvoicingCategoryInfo = () => {
  ...
  const consumablesData = [
    { CategoryName: "Wheels",CategoryCode:"Spares", Action: "" },
    { CategoryName: "Radiator Coolant",CategoryCode:"Consumables", Action: "" },
    { CategoryName: "Power Steering oil ",CategoryCode:"Consumables", Action: "" },
    { CategoryName: "Others",CategoryCode:"Consumables", Action: "" },
    { CategoryName: "Nuts and Bolts",CategoryCode:"Consumables", Action: "" },
    { CategoryName: "Lubricants ",CategoryCode:"Consumables", Action: "" },
    { CategoryName: "Accessories",CategoryCode:"Spares", Action: "" },
    { CategoryName: "Gearbox oil",CategoryCode:"Consumables", Action: "" },
    { CategoryName: "AC Gas Oil ",CategoryCode:"Consumables", Action: "" },
                ...
                >
                  <div className="table-responsive mt-4">
                    <table className="table table-bordered text-nowrap border-bottom m-0">
                      ...
                      <tbody>
                        {filterData(consumablesData, "CategoryName")
                          .length > 0 ? (
                          filterData(
                            consumablesData,
                            "CategoryName"
                              ...
                              <td>
                                <div className="row">
                                  ...
                                  <button
                                    ...
                                    onClick={() =>
                                      handleEditClick(item.CategoryName)
                                    }
                                    style={{ marginLeft: "5px" }}
                                  ></button>
                                  <button
