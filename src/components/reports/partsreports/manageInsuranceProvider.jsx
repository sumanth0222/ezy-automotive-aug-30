    ...
    return (
        <Fragment>
            <Pageheader
                ...
                active="Manage Insurance Provider"
            />
                    ...
                    <Card className="p-0">
                        ...
                        >
                            <div className="row-sm row align-items-center">
                                ...
                                <div>
                                    <h6 className="">Manage Insurance Provider</h6>
                                </div>
                            </div>
                            <div className="row-sm row align-items-center">
                                    ...
                                    <table className="table table-bordered text-nowrap border-bottom m-0">
                                        <thead>
                                            <tr>
                                                ...
                                                <th>Email Id</th>
                                                <th>Action</th> {/* Keeping Action column */}
                                            </tr>
                                        </thead>
                                        <tbody>
                                            {/* Sample Data 1 */}
                                            <tr>
                                                <td>HDFC General Insurance</td>
                                                <td>GSTIN123456</td>
                                                <td>Hyderabad</td>
                                                <td>0123456789</td>
                                                <td></td> {/* Email is empty in your image */}
                                                <td>
                                            ...
                                            <tr>
                                                <td>Bajaj Allianz</td>
                                                <td></td> {/* GST number is missing in your image */}
                                                <td>Hyderabad</td>
                                                <td></td> {/* Contact number is missing */}
                                                <td></td> {/* Email is missing */}
                                                <td>
                                                    <div className="dropdown">
                                                        <button
                                                            className="btn btn-sm btn-secondary"
