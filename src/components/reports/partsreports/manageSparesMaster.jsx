...
const ManageSparesMaster = () => {
  ...
  const consumablesData = [
    { PartsName: "Wheels",CategoryCode:"Spares", Action: "" },
    { PartsName: "Radiator Coolant",CategoryCode:"Consumables", Action: "" },
    { PartsName: "Power Steering oil ",CategoryCode:"Consumables", Action: "" },
    { PartsName: "Others",CategoryCode:"Consumables", Action: "" },
    { PartsName: "Nuts and Bolts",CategoryCode:"Consumables", Action: "" },
    { PartsName: "Lubricants ",CategoryCode:"Consumables", Action: "" },
    { PartsName: "Accessories",CategoryCode:"Spares", Action: "" },
    { PartsName: "Gearbox oil",CategoryCode:"Consumables", Action: "" },
    { PartsName: "AC Gas Oil ",CategoryCode:"Consumables", Action: "" },
          ...
          <Card className="p-0">
            ...
            >
              <div className="row-sm row align-items-center">
                ...
                <div>
                  <h6 className="">Manage Spares Master</h6>
                </div>
              </div>
                ...
                >
                  <div className="table-responsive mt-4">
                    <table className="table table-bordered text-nowrap border-bottom m-0">
                      ...
                      <tbody>
                        {filterData(consumablesData, "PartsName")
                          .length > 0 ? (
                          filterData(
                            consumablesData,
                            "PartsName"
                              ...
                              <td>
                                <div className="row">
                                  ...
                                  <button
                                    ...
                                    onClick={() =>
                                      handleEditClick(item.PartsName)
                                    }
                                    style={{ marginLeft: "5px" }}
                                  ></button>
                                  <button
...
export default ManageSparesMaster;
