...
const ManageConsumbleBrands = () => {
  ...
  const consumablesData = [
    { consumablesBrandName: "SPARES", Action: "" },
    { consumablesBrandName: "TEST WABCO", Action: "" },
    { consumablesBrandName: "TEST MOTHERSON", Action: "" },
    { consumablesBrandName: "TEST ZF", Action: "" },
    { consumablesBrandName: "TEST BOSCH", Action: "" },
    { consumablesBrandName: "TEST RANE", Action: "" },
    { consumablesBrandName: "TEST WURTH", Action: "" },
    { consumablesBrandName: "Shell", Action: "" },
    { consumablesBrandName: "GULF", Action: "" },
    { consumablesBrandName: "Dupont", Action: "" },
  ];
  ...
  return (
    <Fragment>
      <Pageheader
        ...
        active="Manage Consumble Brands"
      />
          ...
          <Card className="p-0">
            ...
            >
              <div className="row-sm row align-items-center">
                ...
                <div>
                  <h6 className="">Manage Consumble Brands</h6>
                </div>
              </div>
                ...
                >
                  <div className="table-responsive mt-4">
                    <table className="table table-bordered text-nowrap border-bottom m-0">
                      <thead>
                        <tr>
                          <th>Consumables Brand Name</th>
                          <th>Action</th>
                        </tr>
                      </thead>
                      <tbody>
                        {filterData(consumablesData, "consumablesBrandName")
                          .length > 0 ? (
                          filterData(
                            consumablesData,
                            "consumablesBrandName"
                          ).map((item, index) => (
                            <tr key={index}>
                              <td>{item.consumablesBrandName}</td>
                              <td>
                                <div className="row">
                                  <button
                                  ...
                                  <button
                                    ...
                                    onClick={() =>
                                      handleEditClick(item.consumablesBrandName)
                                    }
                                    style={{ marginLeft: "5px" }}
                                  ></button>
                                  <button
...
export default ManageConsumbleBrands;
