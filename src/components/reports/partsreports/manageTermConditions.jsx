...
const ManageTermConditions = () => {
    ...
    const consumablesData = [
        { InvoiceBillTnC: "", JobCardTnC: "", InsuranceBillTnC: "", bankdetailstnc: ""},
                    ...
                    <Card className="p-0">
                        ...
                        >
                            <div className="row-sm row align-items-center">
                                ...
                                <div>
                                    <h6 className="">Manage Term & Conditions</h6>
                                </div>
                            </div>
                                ...
                                >
                                    <div className="table-responsive mt-4">
                                        <table className="table table-bordered text-nowrap border-bottom m-0">
                                            <thead>
                                                <tr>
                                                    <th>Invoice Bill TnC</th>
                                                    <th>JobCard TnC</th>
                                                    <th>InsuranceBill TnC</th>
                                                    <th>bankdetails_tnc</th>
                                                    
                                                    <th>Action</th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                {filterData(consumablesData, "InvoiceBillTnC")
                                                    .length > 0 ? (
                                                    filterData(
                                                        consumablesData,
                                                        "InvoiceBillTnC"
                                                        ...
                                                        <tr key={index}>
                                                            <td>{item.InvoiceBillTnC}</td>
                                                            <td>{item.JobCardTnC}</td>
                                                            <td>{item.InsuranceBillTnC}</td>
                                                            <td>{item.bankdetailstnc}</td>
...
export default ManageTermConditions;
