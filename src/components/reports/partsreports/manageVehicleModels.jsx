...
const ManageVehicleModels = () => {
  ...
  const consumablesData = [
    { brand: "Mahindra", vehiclemodel: "Thar", vehiclevariant: "LX HARDTOP", Action:"" },
    { brand: "Volkswagen", vehiclemodel: "VIRTUS", vehiclevariant: "TOPLINE TSI", Action:"" },
    { brand: "Mahindra", vehiclemodel: "Scorpio", vehiclevariant: "N-Z4 4X4", Action:"" },
    { brand: "Toyota", vehiclemodel: "Innova", vehiclevariant: "CRYSTA 2.4G", Action:"" },
    { brand: "Audi", vehiclemodel: "A3", vehiclevariant: "2.0 TSI", Action:"" },
    { brand: "Volvo", vehiclemodel: "S80", vehiclevariant: "Volvo D4 SUMMUM", Action:"" },
  ...
  return (
    <Fragment>
      <Pageheader title="System Configuration" heading="System Configuration" active="Manage Vehicle Models" />
          ...
          <Card className="p-0">
            ...
            >
              <div className="row-sm row align-items-center">
                ...
                <div>
                  <h6 className="">Manage Vehicle Models</h6>
                </div>
              </div>
...
export default ManageVehicleModels;
