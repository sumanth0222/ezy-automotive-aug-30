...
const SupplierOrder = () => {
  ...
  const handleAddRow = () => {
    setRows([...rows, { product: '', description: '', jobcard: '',duedate:'', unitcost: 0, qty: 1, tax: 0, lineTotal: 0 }]);
  };
  ...
  const handleRowChange = (index, field, value) => {
   ...
   const [rows, setRows] = useState([
    { product: 'LAB', description: 'Labour', jobcard: '',duedate:'',unitcost: 0, qty: 1, tax: 0, lineTotal: 0 }
  ]);
  ...
  return (
    ...
    <Fragment>
      ...
      {/* <Pageheader />   */}
      <Pageheader title="Suppliers" heading="Pages" active="Orders" />
...
SupplierOrder.propTypes = {};

SupplierOrder.defaultProps = {};
